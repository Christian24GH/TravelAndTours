...
export default function TrainingManagement() {
	...
	const processedRows = React.useMemo(() => {
		...
		return sorted;
	}, [trainings, searchQuery, sortBy, sortDirection]);
							...
							<Table>
								...
								<TableBody>
									 {visibleRows.length > 0
												 ...
												 <TableRow key={training.id} className="align-top">
													 ...
													 <TableCell>
														 <div className="w-40 bg-gray-200 rounded">
															 <div className="bg-blue-600 text-white text-xs px-2 py-1 rounded" style={{ width: `${training.progress}%` }}>{training.progress}%</div>
														 </div>
													 </TableCell>
										 ...
										 : (
												 <TableRow>
													 <TableCell className="text-center text-gray-600" colSpan="6">No trainings available.</TableCell>
												 </TableRow>
											 )}
								</TableBody>
							</Table>
